...
void keyboardCallback(GLFWwindow* window, int key, int scancode, int action, int mode) {
	...
	//trigger Camera animation preview
...
void initObjects() {
	fullScene.LoadModel("objects/fullScene/fullScene3.obj");
	ground.LoadModel("objects/ground/ground2.obj");
	trees.LoadModel("objects/trees/trees.obj");
	bigTrees.LoadModel("objects/bigTrees/bigTrees.obj");
	slide.LoadModel("objects/slide/slide.obj");
	...
	lightCube.LoadModel("objects/cube/cube2.obj");
...
void initUniforms() {
	...
	// pointlight
	lightPos = glm::vec3(-6.588f, 5.32f, 10.748f);
...
void drawObjects(gps::Shader shader, bool depthPass) {
	...
	shader.useShaderProgram();
	//model = glm::rotate(model, glm::radians(angleFish), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::rotate(glm::mat4(1.0f), glm::radians(angleY), glm::vec3(0.0f, 1.0f, 0.0f));
